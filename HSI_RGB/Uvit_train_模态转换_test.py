...
class Diffusion(nn.Module):
    ...
    def p_mean_variance(self, x, t, clip_denoised: bool, condition_x=None, mode=None):
        ...
        if mode == 'HSI_to_RGB':
            x_start, feature = self.model_HSI_to_RGB(torch.cat([condition_x, x], dim=1), timesteps=noise_level)
        elif mode == 'RGB_to_HSI':
            x_start, feature = self.model_RGB_to_HSI(torch.cat([condition_x, x], dim=1), timesteps=noise_level)
    ...
    def p_sample(self, img_RGB, img_HSI, t, clip_denoised=True, condition_RGB=None, condition_HSI=None):
        ...
        mean1, log_variance1, x_start1, feature1 = self.p_mean_variance(x=img_RGB, t=t, clip_denoised=clip_denoised, condition_x=condition_HSI, mode='HSI_to_RGB')

        mean2, log_variance2, x_start2, feature2 = self.p_mean_variance(x=img_HSI, t=t, clip_denoised=clip_denoised, condition_x=condition_RGB, mode='RGB_to_HSI')
        ...
        return mean1 + noise1 * (0.5 * log_variance1).exp(), x_start1, feature1, mean2 + noise2 * (0.5 * log_variance2).exp(), x_start2, feature2

    # Progress whole reverse diffusion process
    @torch.no_grad()
    def super_resolution(self, RGB, SAR):
        img_RGB = torch.rand_like(RGB, device=RGB.device)
        img_SAR = torch.rand_like(SAR, device=SAR.device)
        ...
        for i in reversed(range(0, self.num_timesteps)):
            ...
            img_RGB, x_start_RGB, feature_RGB, img_SAR, x_start_SAR, feature_SAR  = self.p_sample(img_RGB, img_SAR, i, condition_RGB=RGB, condition_HSI=SAR)
            if i==1999:
    ...
    def net(self, RGB, HSI):
        ...
        t = np.random.randint(1, self.num_timesteps + 1)
        sqrt_alpha = torch.FloatTensor(
            np.random.uniform(self.sqrt_alphas_cumprod_prev[t - 1], self.sqrt_alphas_cumprod_prev[t], size=b)).to(
            RGB.device)
        sqrt_alpha = sqrt_alpha.view(-1, 1, 1, 1)
        ...
        for i in range(epoch):
            ...
            if (i + 1) % verbose == 0:
                ...
                for step, [RGB, SAR] in enumerate(tqdm(self.testloader)):
                    ...
                    plt.show()
                    plt.close()
                    # plt.savefig('./img/大图生成/Result_test' + str(step) + '.jpg')

                # Save model weight

                # sio.savemat('./mat_file/2000_1000_0_layer_f/RGB_All_f_step0_0.mat', {"RGB_All_f_step0_0": RGB_All_f_step0_0.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/SAR_All_f_step0_0.mat', {"SAR_All_f_step0_0": SAR_All_f_step0_0.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/RGB_All_f_step0_1.mat', {"RGB_All_f_step0_1": RGB_All_f_step0_1.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/SAR_All_f_step0_1.mat', {"SAR_All_f_step0_1": SAR_All_f_step0_1.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/RGB_All_f_step0_2.mat', {"RGB_All_f_step0_2": RGB_All_f_step0_2.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/SAR_All_f_step0_2.mat', {"SAR_All_f_step0_2": SAR_All_f_step0_2.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/RGB_All_f_step0_3.mat', {"RGB_All_f_step0_3": RGB_All_f_step0_3.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/SAR_All_f_step0_3.mat', {"SAR_All_f_step0_3": SAR_All_f_step0_3.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/RGB_All_f_step0_4.mat', {"RGB_All_f_step0_4": RGB_All_f_step0_4.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/SAR_All_f_step0_4.mat', {"SAR_All_f_step0_4": SAR_All_f_step0_4.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/RGB_All_x_0.mat', {"RGB_All_x_0": RGB_All_x_0.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/SAR_All_x_0.mat', {"SAR_All_x_0": SAR_All_x_0.cpu().numpy()})
                #
                # sio.savemat('./mat_file/2000_1000_0_layer_f/RGB_All_f_step1000_0.mat', {"RGB_All_f_step1000_0": RGB_All_f_step1000_1.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/SAR_All_f_step1000_0.mat', {"SAR_All_f_step1000_0": SAR_All_f_step1000_1.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/RGB_All_f_step1000_1.mat', {"RGB_All_f_step1000_1": RGB_All_f_step1000_1.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/SAR_All_f_step1000_1.mat', {"SAR_All_f_step1000_1": SAR_All_f_step1000_1.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/RGB_All_f_step1000_2.mat', {"RGB_All_f_step1000_2": RGB_All_f_step1000_2.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/SAR_All_f_step1000_2.mat', {"SAR_All_f_step1000_2": SAR_All_f_step1000_2.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/RGB_All_f_step1000_3.mat', {"RGB_All_f_step1000_3": RGB_All_f_step1000_3.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/SAR_All_f_step1000_3.mat', {"SAR_All_f_step1000_3": SAR_All_f_step1000_3.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/RGB_All_f_step1000_4.mat', {"RGB_All_f_step1000_4": RGB_All_f_step1000_4.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/SAR_All_f_step1000_4.mat', {"SAR_All_f_step1000_4": SAR_All_f_step1000_4.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/RGB_All_f_step1000_6.mat', {"RGB_All_f_step1000_6": RGB_All_f_step1000_6.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/SAR_All_f_step1000_6.mat', {"SAR_All_f_step1000_6": SAR_All_f_step1000_6.cpu().numpy()})
                #
                # sio.savemat('./mat_file/2000_1000_0_layer_f/RGB_All_f_step2000_0.mat', {"RGB_All_f_step2000_0": RGB_All_f_step2000_0.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/SAR_All_f_step2000_0.mat', {"SAR_All_f_step2000_0": SAR_All_f_step2000_0.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/RGB_All_f_step2000_1.mat', {"RGB_All_f_step2000_1": RGB_All_f_step2000_1.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/SAR_All_f_step2000_1.mat', {"SAR_All_f_step2000_1": SAR_All_f_step2000_1.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/RGB_All_f_step2000_2.mat', {"RGB_All_f_step2000_2": RGB_All_f_step2000_2.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/SAR_All_f_step2000_2.mat', {"SAR_All_f_step2000_2": SAR_All_f_step2000_2.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/RGB_All_f_step2000_3.mat', {"RGB_All_f_step2000_3": RGB_All_f_step2000_3.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/SAR_All_f_step2000_3.mat', {"SAR_All_f_step2000_3": SAR_All_f_step2000_3.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/RGB_All_f_step2000_4.mat', {"RGB_All_f_step2000_4": RGB_All_f_step2000_4.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/SAR_All_f_step2000_4.mat', {"SAR_All_f_step2000_4": SAR_All_f_step2000_4.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/RGB_All_f_step2000_6.mat', {"RGB_All_f_step2000_6": RGB_All_f_step2000_6.cpu().numpy()})
                # sio.savemat('./mat_file/2000_1000_0_layer_f/SAR_All_f_step2000_6.mat', {"SAR_All_f_step2000_6": SAR_All_f_step2000_6.cpu().numpy()})
                ...
                sio.savemat('./mat_file/2000_1000_0_layer_f/T1_x_0.mat', {"T1_x_0": RGB_x_0.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T2_x_0.mat', {"T2_x_0": SAR_x_0.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T1_f_step0_0.mat', {"T1_f_step0_0": RGB_f_step0_0.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T2_f_step0_0.mat', {"T2_f_step0_0": SAR_f_step0_0.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T1_f_step0_1.mat', {"T1_f_step0_1": RGB_f_step0_1.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T2_f_step0_1.mat', {"T2_f_step0_1": SAR_f_step0_1.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T1_f_step0_2.mat', {"T1_f_step0_2": RGB_f_step0_2.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T2_f_step0_2.mat', {"T2_f_step0_2": SAR_f_step0_2.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T1_f_step0_3.mat', {"T1_f_step0_3": RGB_f_step0_3.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T2_f_step0_3.mat', {"T2_f_step0_3": SAR_f_step0_3.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T1_f_step0_4.mat', {"T1_f_step0_4": RGB_f_step0_4.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T2_f_step0_4.mat', {"T2_f_step0_4": SAR_f_step0_4.cpu().numpy()})

                sio.savemat('./mat_file/2000_1000_0_layer_f/T1_f_step1000_0.mat', {"T1_f_step1000_0": RGB_f_step1000_0.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T2_f_step1000_0.mat', {"T2_f_step1000_0": SAR_f_step1000_0.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T1_f_step1000_1.mat', {"T1_f_step1000_1": RGB_f_step1000_1.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T2_f_step1000_1.mat', {"T2_f_step1000_1": SAR_f_step1000_1.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T1_f_step1000_2.mat', {"T1_f_step1000_2": RGB_f_step1000_2.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T2_f_step1000_2.mat', {"T2_f_step1000_2": SAR_f_step1000_2.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T1_f_step1000_3.mat', {"T1_f_step1000_3": RGB_f_step1000_3.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T2_f_step1000_3.mat', {"T2_f_step1000_3": SAR_f_step1000_3.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T1_f_step1000_4.mat', {"T1_f_step1000_4": RGB_f_step1000_4.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T2_f_step1000_4.mat', {"T2_f_step1000_4": SAR_f_step1000_4.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T1_f_step1000_6.mat', {"T1_f_step1000_6": RGB_f_step1000_6.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T2_f_step1000_6.mat', {"T2_f_step1000_6": SAR_f_step1000_6.cpu().numpy()})

                sio.savemat('./mat_file/2000_1000_0_layer_f/T1_f_step2000_0.mat', {"T1_f_step2000_0": RGB_f_step2000_0.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T2_f_step2000_0.mat', {"T2_f_step2000_0": SAR_f_step2000_0.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T1_f_step2000_1.mat', {"T1_f_step2000_1": RGB_f_step2000_1.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T2_f_step2000_1.mat', {"T2_f_step2000_1": SAR_f_step2000_1.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T1_f_step2000_2.mat', {"T1_f_step2000_2": RGB_f_step2000_2.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T2_f_step2000_2.mat', {"T2_f_step2000_2": SAR_f_step2000_2.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T1_f_step2000_3.mat', {"T1_f_step2000_3": RGB_f_step2000_3.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T2_f_step2000_3.mat', {"T2_f_step2000_3": SAR_f_step2000_3.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T1_f_step2000_4.mat', {"T1_f_step2000_4": RGB_f_step2000_4.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T2_f_step2000_4.mat', {"T2_f_step2000_4": SAR_f_step2000_4.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T1_f_step2000_6.mat', {"T1_f_step2000_6": RGB_f_step2000_6.cpu().numpy()})
                sio.savemat('./mat_file/2000_1000_0_layer_f/T2_f_step2000_6.mat', {"T2_f_step2000_6": SAR_f_step2000_6.cpu().numpy()})
...
if __name__ == "__main__":
    ...
    LR_size = 32
    img_size = 128
    root = '../data/data_4_HSI_RGB/'

    train_data = Dataset(root+"T1_RGB.mat", root+"T2_HSI.mat", root+"REF.mat", data='Data_4', mode='train', channel=3)
    train_dataloader = DataLoader(train_data, batch_size=batch_size, shuffle=True, num_workers=4, pin_memory=True)
    test_data = Dataset(root+"T1_RGB.mat", root+"T2_HSI.mat", root+"REF.mat", data='Data_4', mode='test', channel=3)
    ...
    sr3 = SR3(device, img_size=img_size, LR_size=LR_size, loss_type='l1',
              ...
              load_path='../TS_model/Data_4_HSI_RGB/feature_5/model_epoch-1099.pt', load=True,
              inner_channel=64,
