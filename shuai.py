...
def grid2contour(grid):
    ...
    plt.figure()
    plt.contour(X, Y, Z1, 10, colors='k')
    plt.contour(X, Y, Z2, 10, colors='k')
...
if __name__ =='__main__':
    ...
    rand_field_norm[:, :, 0] = rand_field_norm[:, :, 0] * 0.8/img_shape[1]
    rand_field_norm[:, :, 1] = rand_field_norm[:, :, 1] * 0.8/img_shape[0]
