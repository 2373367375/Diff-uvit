...
class Dataset(nn.Module):
    ...
    def __init__(self, name1, name2, REF, data, mode, channel=128, padding = 2, nums = 500):
        ...
        if data == "Data_3":
            ...
            self.Data_all['T1_x_org'] = loadmat(os.path.join(self.filename_T1))['RGB_Norm'][0:297, 0:405, :]
            self.Data_all['T2_x_org'] = loadmat(os.path.join(self.filename_T2))['NIR_Norm'][0:297, 0:405, :]

            self.image_REF = loadmat(os.path.join(self.REF))['GT']
            self.image_REF = self.image_REF[0:297, 0:405, 0]
