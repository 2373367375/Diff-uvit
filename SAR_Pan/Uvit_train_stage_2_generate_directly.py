...
class SR3():
    def __init__(self, device, img_size, LR_size, loss_type, dataloader, testloader,
        ...
        self.Net = Shared_VisionTransformer(5, input_channels=1, patch_size=2, depth=4, dim=128, heads = 4,mlp_dim=64, dropout=0.3,dim_head=16).to(device)
...
if __name__ == "__main__":
    ...
    train_data = Dataset(root+"Q1.mat", root+"Q2.mat", root+"REF.mat",data='Data_2', mode='train', channel=3)
    train_dataloader = DataLoader(train_data, batch_size=batch_size, shuffle=True, num_workers=4, pin_memory=True)
    test_data = Dataset(root+"Q1.mat", root+"Q2.mat", root+"REF.mat",data='Data_2', mode='test', channel=3)
