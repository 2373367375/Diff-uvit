...
class SR3():
    def __init__(self, device, img_size, LR_size, loss_type, dataloader, testloader,
        ...
        model_RGB_to_SAR = UViT(27, 1, 2)
        model_SAR_to_RGB = UViT(27, 1, 2)
...
if __name__ == "__main__":
    ...
    test_data = Dataset(root+"Pan_Norm.mat", root+"SAR_Norm.mat", root+"GT.mat", data='Data_2', mode='test', channel=1)
    ...
    sr3 = SR3(device, img_size=img_size, LR_size=LR_size, loss_type='l1',
              ...
              load_path='../TS_model/Data_2_SAR_Pan/feature_5/model_epoch-1979.pt', load=True,
              inner_channel=64,
