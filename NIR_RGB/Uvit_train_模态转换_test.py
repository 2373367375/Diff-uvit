...
if __name__ == "__main__":
    ...
    LR_size = 32
    img_size = 128
    root = '../data/data_3_NIR_RGB/'

    train_data = Dataset(root+"RGB_Norm.mat", root+"NIR_Norm.mat", root+"GT.mat", data='Data_3', mode='train', channel=3)
    train_dataloader = DataLoader(train_data, batch_size=batch_size, shuffle=True, num_workers=4, pin_memory=True)
    test_data = Dataset(root+"RGB_Norm.mat", root+"NIR_Norm.mat", root+"GT.mat", data='Data_3', mode='test', channel=3)
    ...
    sr3 = SR3(device, img_size=img_size, LR_size=LR_size, loss_type='l1',
              ...
              load_path='../TS_model/Data_3_NIR_RGB/feature_5/model_epoch-619.pt', load=True,
              inner_channel=64,
