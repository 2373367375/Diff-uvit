...
class CD_Net(nn.Module):
    ...
    def forward(self, Data_patch):
        ...
        feature_step_RGB_0 = self.conv_feature(torch.cat(
            [Data_patch['RGB_f_step0_1_patch'], Data_patch['RGB_f_step0_2_patch'],
             Data_patch['RGB_f_step0_3_patch'],
             Data_patch['RGB_f_step0_4_patch']], dim=1))

        feature_step_RGB_1000 = self.conv_feature(torch.cat(
            [Data_patch['RGB_f_step1000_1_patch'], Data_patch['RGB_f_step1000_2_patch'],
             Data_patch['RGB_f_step1000_3_patch'],
             Data_patch['RGB_f_step1000_4_patch']], dim=1))
        feature_step_RGB_2000 = self.conv_feature(torch.cat(
            [Data_patch['RGB_f_step2000_1_patch'], Data_patch['RGB_f_step2000_2_patch'],
             Data_patch['RGB_f_step2000_3_patch'],
             Data_patch['RGB_f_step2000_4_patch']], dim=1))
        feature_step_SAR_0 = self.conv_feature(torch.cat(
            [Data_patch['SAR_f_step0_1_patch'], Data_patch['SAR_f_step0_2_patch'],
             Data_patch['SAR_f_step0_3_patch'],
             Data_patch['SAR_f_step0_4_patch']], dim=1))
        feature_step_SAR_1000 = self.conv_feature(torch.cat(
            [Data_patch['SAR_f_step1000_1_patch'], Data_patch['SAR_f_step1000_2_patch'],
             Data_patch['SAR_f_step1000_3_patch'],
             Data_patch['SAR_f_step1000_4_patch']], dim=1))
        feature_step_SAR_2000 = self.conv_feature(torch.cat(
            [Data_patch['SAR_f_step2000_1_patch'], Data_patch['SAR_f_step2000_2_patch'],
             Data_patch['SAR_f_step2000_3_patch'],
             Data_patch['SAR_f_step2000_4_patch']], dim=1))
        ...
        SAR_step_0 = self.CD_blocks[3](Data_patch['SAR_f_step0_0_patch'], Data_patch['RGB_x_0_patch'])
        RGB_step_0 = self.CD_blocks[4](Data_patch['SAR_x_0_patch'], Data_patch['RGB_f_step0_0_patch'])
        SAR_step_1000 = self.CD_blocks[5](Data_patch['SAR_f_step1000_0_patch'], Data_patch['RGB_f_step1000_6_patch'])
        RGB_step_1000 = self.CD_blocks[6](Data_patch['SAR_f_step1000_6_patch'], Data_patch['RGB_f_step1000_0_patch'])
        SAR_step_2000 = self.CD_blocks[7](Data_patch['SAR_f_step2000_0_patch'], Data_patch['RGB_f_step2000_6_patch'])
        RGB_step_2000 = self.CD_blocks[8](Data_patch['SAR_f_step2000_6_patch'], Data_patch['RGB_f_step2000_0_patch'])
